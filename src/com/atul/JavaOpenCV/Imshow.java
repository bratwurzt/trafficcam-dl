...
public class Imshow
{
  ...
  /**
   * Sets whether this window should be resizable or not, by default it is not resizable
   *
   * @param resizable <code>true</code> if the window should be resizable, <code>false</code> otherwise
   */
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with the given title as the title for the window
   *
   * @param mat the {@link Mat} to display
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with the given title as the title for the window and determines whether the frame is resizable or not
   *
   * @param mat the {@link Mat} to display
   * @param frameTitle the title for the frame
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with a set size
   *
   * @param mat the {@link Mat} to display
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with a set size and given title
   *
   * @param mat the {@link Mat} to display
   * @param frameSize the size for the frame
   * @param frameTitle the title for the frame
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with a set size and given title and whether it is resizable or not
   *
   * @param mat the {@link Mat} to display
   * @param frameSize the size for the frame
   * @param frameTitle the title for the frame
  ...
  public static void show(
      Mat mat, Dimension frameSize, String frameTitle,
      boolean resizable)
  {
  ...
  /**
   * Displays the given {@link Mat} in a new instance of {@link Imshow} with a set size and given title and whether it is resizable or not, and with the close operation set
   *
   * @param mat the {@link Mat} to display
   * @param frameSize the size for the frame
   * @param frameTitle the title for the frame
