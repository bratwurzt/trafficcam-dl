...
public class WeatherTimeline {
  ...
  @Id
  @SequenceGenerator(name = "weather_timeline_id_seq", sequenceName = "weather_timeline_id_seq", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "weather_timeline_id_seq")
